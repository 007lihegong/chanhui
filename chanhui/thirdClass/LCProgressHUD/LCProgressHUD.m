...
//    [hud setLabelFont:[UIFont boldSystemFontOfSize:TEXT_SIZE]];
    [hud setLabelFont:[UIFont fontWithName:@"Avenir-Light" size:14]];
    if (text.length) {
        [hud setMinSize:CGSizeMake(BGVIEW_WIDTH, BGVIEW_WIDTH)];
    }else {
        [hud setMinSize:CGSizeMake(50, 50)];
    }
...
+ (void)showMessage:(NSString *)text {
    ...
    [hud show:YES];
    [hud setLabelText:text];
    [hud setLabelFont:[UIFont fontWithName:@"Avenir-Light" size:16]];
